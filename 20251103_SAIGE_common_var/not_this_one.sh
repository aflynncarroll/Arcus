...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251017_total_200_SAIGE/p200_multi_saige.sh

# lab-tasks submit-script --name saige-asd --path /mnt/arcus/lab/users/flynncarra/projects/20251017_total_200_SAIGE/p200_multi_saige.sh --split 226 --parallel 5 --cpu 4 --memory 40 --ett 24

# lab-tasks status scit1011-autism-gwas_saige-asd_4080