...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251103_SAIGE_common_var
P_FILE=/mnt/arcus/lab/project/data/interim/total_eur/eur_0.05_chrom/eur_5_total
PHENOFILE=/mnt/arcus/lab/users/flynncarra/projects/20251103_phewas_v3_phenotypes/array_eur_total_phe_200_v2.tsv
PHENO_LIST=/mnt/arcus/lab/users/flynncarra/projects/20251103_phewas_v3_phenotypes/phecodes_200_v2.txt
...
# Rscript ${SAIGE_SOFTWARE}/step1_fitNULLGLMM.R \
#     --useSparseGRMtoFitNULL=TRUE \
#     --sparseGRMFile=${WORKDIR}/sparseGRM/sparseGRM.RDS \
#     --phenoFile=$PHENOFILE \
#     --skipVarianceRatioEstimation=FALSE \
#     --phenoCol=$phecode \
#     --covarColList=$COVARS \
...
for CHR in {1..22}; do
    ...
    Rscript ${SAIGE_SOFTWARE}/step2_SPAtests.R \
        --vcfFile=/mnt/arcus/lab/project/data/interim/total_eur/eur_0.05_chrom/eur_5_chr${CHR}.vcf.gz \
        --vcfFileIndex=/mnt/arcus/lab/project/data/interim/total_eur/eur_0.05_chrom/eur_5_chr${CHR}.vcf.gz.csi \
        --vcfField=GT \
        --chrom=$CHR \
        --variantFile=$VARIANT_LIST \
        --minMAF=0 \
        --minMAC=20 \
        --LOCO=FALSE \
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251023_SAIGE_eur_total_var/run_total_var_saige.sh

# lab-tasks submit-script --name saige-total-var --path /mnt/arcus/lab/users/flynncarra/projects/20251023_SAIGE_eur_total_var/run_total_var_saige.sh --split 226 --parallel 5 --cpu 4 --memory 55 --ett 30

# lab-tasks status scit1011-autism-gwas_saige-total-var_4252