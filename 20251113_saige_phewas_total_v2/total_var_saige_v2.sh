...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251113_saige_phewas_total_v2/
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251113_saige_phewas_total_v2/total_var_saige_v2.sh

# lab-tasks submit-script --name saige-shared-phe --path /mnt/arcus/lab/users/flynncarra/projects/20251113_saige_phewas_total_v2/total_var_saige_v2.sh --split 226 --parallel 5 --cpu 4 --memory 55 --ett 125

# lab-tasks status scit1011-autism-gwas_saige-shared-phe_4275