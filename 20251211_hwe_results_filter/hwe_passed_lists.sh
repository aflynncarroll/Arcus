...
# 396 markers to be excluded based on HWE test ( p <= 1e-10 )
...
# 930 markers to be excluded based on HWE test ( p <= 1e-10 )
...
mkdir /home/flynncarra/projects/20251211_hwe_results_filter/saige_results
