...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251124_blood_phewas_updated_covar/
...
COVARS="sex,age,age_sqr,PC1,PC2,PC3,HDS"
QCOVARS="sex,HDS"
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251124_blood_phewas_updated_covar/blood_saige_pc.sh

# lab-tasks submit-script --name saige-1c18651582-blood --path /mnt/arcus/lab/users/flynncarra/projects/20251124_blood_phewas_updated_covar/blood_saige_pc.sh  --split 8 --parallel 5 --cpu 4 --memory 55 --ett 10

# lab-tasks status scit1011-autism-gwas_saige-1c18651582-blood_3137