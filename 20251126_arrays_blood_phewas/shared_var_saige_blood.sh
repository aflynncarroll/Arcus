...
# Paths
# ----------------------------
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251126_arrays_blood_phewas/

PHENOFILE=/mnt/arcus/lab/users/flynncarra/projects/20251124_blood_phewas_updated_covar/rw_blood_phenos.tsv
PHENO_LIST=/mnt/arcus/lab/users/flynncarra/projects/20251126_arrays_blood_phewas/rw_med_blood_phenos_list.txt

ARRAY_LIST=/mnt/arcus/lab/users/flynncarra/projects/20251120_single_array_phewas/array_list.txt

COVARS="age,age_sqr,sex,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10,HDS"
QCOVARS="sex,HDS"
...
# for ARRAY=34505c4e9a, PHENO=median_WBC the sparse array did not work (step 2 failed) so I ran full GRM
    # Rscript ${SAIGE_SOFTWARE}/step1_fitNULLGLMM.R \
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251126_arrays_blood_phewas/shared_var_saige_blood.sh

# lab-tasks submit-script --name saige-indv-array-blood --path /mnt/arcus/lab/users/flynncarra/projects/20251126_arrays_blood_phewas/shared_var_saige_blood.sh  --split 10 --parallel 5 --cpu 4 --memory 55 --ett 24

# lab-tasks status scit1011-autism-gwas_saige-indv-array-blood_6659
