...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251218_afr_phewas_hwe_1e6/run_metals_afr.sh

# lab-tasks submit-script --name metal-afr-phe --path /mnt/arcus/lab/users/flynncarra/projects/20251218_afr_phewas_hwe_1e6/run_metals_afr.sh --split 141 --parallel 5 --cpu 4 --memory 55 --ett 3

# lab-tasks status scit1011-autism-gwas_metal-afr-phe_7561
# lab-tasks status scit1011-autism-gwas_metal-afr-phe_7561 | head -n 20