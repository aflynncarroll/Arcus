...
# need to mkdir results in directory
# need to mkdir step_1_output in directory
...
# Paths
# ----------------------------
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251016_multi_pheno_saige
...
VCF_IDX=/mnt/arcus/lab/project/data/interim/total_eur/eur_0.05_hm3_total.vcf.gz.csi
PHENOFILE=/mnt/arcus/lab/users/flynncarra/projects/20251008_phewas_saige_pheno/array_eur_total_phe_200.tsv
PHENO_LIST=/mnt/arcus/lab/users/flynncarra/projects/20251008_phewas_saige_pheno/phecodes_5.txt
GRMFILE=${WORKDIR}/sparseGRM.mtx
COVARS="age,age_sqr,sex,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10"           # Adjust covariates as needed
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251016_multi_pheno_saige/test_multi_saige.sh

# lab-tasks submit-script --name saige-asd --path /mnt/arcus/lab/users/flynncarra/projects/20251016_multi_pheno_saige/test_multi_saige.sh --split 2 --parallel 2 --cpu 4 --memory 32 --ett 2

# lab-tasks status scit1011-autism-gwas_saige-asd_722