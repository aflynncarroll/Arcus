...
vcftools --gzvcf /mnt/arcus/lab/project/data/interim/batch1_2/SCIT1011-AUTISM-GWAS_1c18651582.vcf.gz \
  --keep /mnt/arcus/lab/users/flynncarra/projects/20251008_phewas_saige_pheno/eur_ids.txt \
  --recode --recode-INFO-all \
  --stdout | bgzip > EUR_SCIT1011-AUTISM-GWAS_1c18651582.vcf.gz
tabix -p vcf EUR_SCIT1011-AUTISM-GWAS_1c18651582.vcf.gz
