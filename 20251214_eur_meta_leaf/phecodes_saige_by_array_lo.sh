...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251214_eur_meta_leaf

PHENOFILE=/mnt/arcus/lab/users/flynncarra/projects/20251103_phewas_v3_phenotypes/array_eur_total_phe_200_v2.tsv
PHENO_LIST=/mnt/arcus/lab/users/flynncarra/projects/20251103_phewas_v3_phenotypes/phecodes_200_v2_lo.txt
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251214_eur_meta_leaf/phecodes_saige_by_array_lo.sh

# lab-tasks submit-script --name saige-indv-array-phecodes --path /mnt/arcus/lab/users/flynncarra/projects/20251214_eur_meta_leaf/phecodes_saige_by_array_lo.sh  --split 700 --parallel 5 --cpu 4 --memory 55 --ett 48

# lab-tasks status scit1011-autism-gwas_saige-indv-array-phecodes_2548

# lab-tasks status scit1011-autism-gwas_saige-indv-array-phecodes_2548 | head -n 20
