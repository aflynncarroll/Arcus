...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251112_saige_shared_plus_array_cov/
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251112_saige_shared_plus_array_cov/shared_var_saige_array_cov.sh

# lab-tasks submit-script --name saige-shared-phe-cov --path /mnt/arcus/lab/users/flynncarra/projects/20251112_saige_shared_plus_array_cov/shared_var_saige_array_cov.sh --split 226 --parallel 5 --cpu 4 --memory 55 --ett 30

# lab-tasks status scit1011-autism-gwas_saige-shared-phe-cov_1746