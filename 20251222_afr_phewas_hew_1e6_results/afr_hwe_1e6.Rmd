---
title: "Results from AFR PheWAS HWE 1e-6"
...
file_list <- list.files(path = "/mnt/arcus/lab/users/flynncarra/projects/20251218_afr_phewas_hwe_1e6/metal_results/", pattern = "\\.txt$", full.names = TRUE)
...
write_csv(top_hits, "top_hits_afr_1e6_meta_phewas.csv")
