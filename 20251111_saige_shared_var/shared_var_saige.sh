...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251111_saige_shared_var/
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251111_saige_shared_var/shared_var_saige.sh

# lab-tasks submit-script --name saige-shared-phe --path /mnt/arcus/lab/users/flynncarra/projects/20251111_saige_shared_var/shared_var_saige.sh --split 226 --parallel 5 --cpu 4 --memory 55 --ett 30

# lab-tasks status scit1011-autism-gwas_saige-shared-phe_3470