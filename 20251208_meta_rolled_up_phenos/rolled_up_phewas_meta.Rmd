---
title: "Rolled up phewas with meta"
...
file_list <- list.files(path = "/mnt/arcus/lab/users/flynncarra/projects/20251208_meta_rolled_up_phenos/metal_results/", pattern = "\\.txt$", full.names = TRUE)
...
# 1. List all files ending with "allchr.txt" in a folder
file_list_fine <- list.files(path = "/mnt/arcus/lab/users/flynncarra/projects/20251205_run_phecode_wide_meta/metal_results/", pattern = "\\.txt$", full.names = TRUE)
...
top_hits <- res[res$P.value<=3.968034e-07,]
...
jpeg(
  filename = "saige_phewas_meta_gws_comb_4e7.jpg",
