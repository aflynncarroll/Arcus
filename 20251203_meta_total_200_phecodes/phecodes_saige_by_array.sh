...
WORKDIR=/mnt/arcus/lab/users/flynncarra/projects/20251203_meta_total_200_phecodes
...
# chmod +x /mnt/arcus/lab/users/flynncarra/projects/20251203_meta_total_200_phecodes/phecodes_saige_by_array.sh

# lab-tasks submit-script --name saige-indv-array-phecodes --path /mnt/arcus/lab/users/flynncarra/projects/20251203_meta_total_200_phecodes/phecodes_saige_by_array.sh  --split 1130 --parallel 5 --cpu 4 --memory 55 --ett 72

# lab-tasks status scit1011-autism-gwas_saige-indv-array-phecodes_106

# lab-tasks status scit1011-autism-gwas_saige-indv-array-phecodes_106 | head -n 200
