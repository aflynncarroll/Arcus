...
WORKDIR=/home/flynncarra/projects/20251213_afr_phewas
...
# ----------------------------
BASE=/mnt/arcus/lab/project/data/interim/batch2/indv_array_phewas_afr/arrays_afr_maf_5_hwe_10/AFR_${ARRAY_NAME}
...
# chmod +x /home/flynncarra/projects/20251213_afr_phewas/afr_phecodes_phewas.sh

# lab-tasks submit-script --name afr-phewas --path /home/flynncarra/projects/20251213_afr_phewas/afr_phecodes_phewas.sh  --split 705 --parallel 5 --cpu 4 --memory 55 --ett 72

# lab-tasks status scit1011-autism-gwas_afr-phewas_7499

# lab-tasks status scit1011-autism-gwas_afr-phewas_7499 | head -n 20
...
#lab-tasks status scit1011-autism-gwas_afr-phewas_7499 > task_status.txt
